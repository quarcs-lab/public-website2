...
| [Convergence clubs analysis using Stata](assets/tutorial-hiYes_log_lp.zip?raw=true)                                                                                      | [Download dataset definitions](assets/dat-definitions.csv.zip?raw=true); [See dataset definitions](/dat-definitions.csv) |
| [Convergence clubs analysis using R](https://deepnote.com/@carlos-mendez/Club-convergence-analysis-9m96OmcrQTu6-5XqG49dKQ)                                                                  | [Download R dataset of developed countries](assets/dat_hiNo.zip?raw=true)                                                |
